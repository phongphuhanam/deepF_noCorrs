...
def draw_matches(img1, kp1, img2, kp2, matches, color=None):
    ...
    if color:
        c = color
    count = 0
    for m,p1,p2 in zip(matches, kp1, kp2):
...
def err_pts_correspond(F, pts1, pts2):
    ...
    for p1, p2 in zip(pts1, pts2):
        ...
        hp1[:2], hp2[:2] = p1, p2
        err += np.abs(np.dot(np.dot(hp2.T, F), hp1))
    return err / float(len(pts1))

if __name__ == "__main__":
    # img1 = cv2.imread('../data/kitti/2011_09_26/2011_09_26_drive_0001_sync/image_02/data/0000000051.png',0)  #queryimage # left image
    # img2 = cv2.imread('../data/kitti/2011_09_26/2011_09_26_drive_0001_sync/image_03/data/0000000051.png',0)  #queryimage # left image
    ...
    F1, pts1, pts2 = sift_get_fmat(img1, img2, total = total, ratio = r, display=True)
    ...
    # F5 = p.get_F(2, 3)
    F5 = np.array([
        [  0.,         0.43450859,   3.04366094],
        [ -0.30021888,  0.5,         11.4300523],
        [ -1.55390937,  -5.71502615, 1.        ]
    ])
    '''
